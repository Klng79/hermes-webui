...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    tab_todos: 'Todos',
    tab_orchtasks: 'Tasks',
    orchtasks_title: 'Orchestration Tasks',
    no_orchtasks: 'No tasks found. Tasks are created by the orchestrator.',
    tab_orchjobs: 'Jobs',
    tab_orchdash: 'Dashboard',
    orchjobs_title: 'Heartbeat Jobs',
    orchdash_title: 'Orchestration Dashboard',
    orchjobs_running: 'running',
    orchjobs_stopped: 'stopped',
    ...
    restart_server_confirm_title: 'Restart Server',
    restart_server_confirm_message: 'This will shut down and restart the WebUI server. Active sessions will be interrupted.',
    restart_server_failed: 'Failed to restart server: ',
    restarting_server: 'Server restarting…',
  ...
  zh: {
    ...
    no_notes_yet: '暂无备注。',
    memory_notes: '记忆',
    memory_add_note: '添加记忆',
    memory_delete_selected: '删除所选',
    memory_delete_confirm: '删除 {n} 条记忆？此操作无法撤销。',
    memory_note_title: '标题',
    memory_note_content: '内容',
    memory_empty: '暂无记忆。点击"添加记忆"创建一个。',
    memory_updated: '记忆已保存',
    memory_created: '记忆已创建',
    memory_deleted: '记忆已删除',
    no_orchtasks: '暂无任务。',
    orchdash_title: '仪表板',
    orchjobs_running: '运行中',
    orchjobs_stopped: '已停止',
    orchjobs_title: '任务',
    orchtasks_title: '任务',
    restart_server: '重启服务器',
    restart_server_confirm_message: '确定要重启服务器吗？',
    restart_server_confirm_title: '确认重启',
    restart_server_failed: '重启失败：',
    restarting_server: '正在重启…',
    tab_orchdash: '仪表板',
    tab_orchjobs: '任务',
    tab_orchtasks: '任务',
